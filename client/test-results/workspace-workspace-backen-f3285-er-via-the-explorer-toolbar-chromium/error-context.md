...
- Name: workspace.spec.ts >> workspace (backend required) >> create a new folder via the explorer toolbar
- Location: e2e/workspace.spec.ts:72:3
        ...
        - generic [ref=e25]:
          ...
          - generic [ref=e26]:
            ...
            - textbox "Email Address" [ref=e28]:
              ...
              - text: e2e-1781219193453-jn276@example.com
        - generic [ref=e29]:
          - text: Password
          - generic [ref=e30]:
